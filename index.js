...
isGameOver == false ) 
{
span[a].parentNode.className += " activeBox";  //making win line as activ  box
...
span[i].innerHTML = "&nbsp;"  //character entity (nonBreakingSpace)
}
playerTurn = "x";
}
...
playAudio('sound/draw-sound.mp3');
}
